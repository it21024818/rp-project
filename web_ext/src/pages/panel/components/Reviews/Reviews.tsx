        ...
        >
          ...
          >
            <Grid container spacing={2} alignItems="center">
              <Grid item xs={10}>
                <Typography sx={{ fontWeight: "bold" }}>Good or Bad</Typography>
              </Grid>
              <Grid item xs={1}>
                <StyledRating
                  name="reaction"
                  ...
                  precision={1}
                  max={1}
                  icon={<ThumbUpIcon sx={{ color: "#72BF78" }} />}
                  emptyIcon={<ThumbUpOutlinedIcon />}
                />
              </Grid>
              <Grid item xs={1}>
                <StyledRating
                  name="reaction"
                  value={newReview.reaction === ReactionEnum.BAD ? 1 : 0}
                  onChange={(_event, newValue) => {
                    setNewReview({
                      ...newReview,
                      reaction:
                        newValue === 1 ? ReactionEnum.BAD : ReactionEnum.GOOD,
                    });
                  }}
                  precision={1}
                  max={1}
                  icon={<ThumbDownIcon sx={{ color: "#FF6500" }} />}
