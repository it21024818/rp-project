...
import { useGetpredictionQualityAnalyticsQuery } from 'src/store/apiquery/predictionsApiSlice';
            ...
            <CardContent>
              <Box sx={{ width: '100%' }}>
                ...
                >
                  ...
                  <Tab label="Quailty Nature" {...a11yProps(1)} />
                </Tabs>
                  ...
                  <Grid container spacing={6}>
                    ...
                    >
                      <Chart
                        ...
                        series={
                          analytics
                            ? [analytics?.sum?.high, analytics?.sum?.low]
                            : [0, 0]
                        }
                        type="donut"
                      />
