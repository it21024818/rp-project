...
import { useGetpredictionSarcasmAnalyticsQuery } from 'src/store/apiquery/predictionsApiSlice';
            ...
            <CardContent>
              <Box sx={{ width: '100%' }}>
                ...
                >
                  ...
                  <Tab label="Sarcastic/Non-Sarcastic" {...a11yProps(1)} />
                  <Tab label="Sarcastic Nature" {...a11yProps(2)} />
                </Tabs>
                  ...
                  <Grid container spacing={6}>
                    ...
                    >
                      <Chart
                        ...
                        series={
                          analytics
                            ? [analytics?.sum?.sarc, analytics?.sum?.notSarc]
                            : [0, 0]
                        }
                        type="donut"
                      />
                      ...
                      >
                        <ListItem disableGutters>
                          ...
                          <Box>
                            ...
                            <Text color="success">
                              {analytics?.sum?.sarc?.toFixed(0)}
                            </Text>
                          </Box>
                        </ListItem>
                        <ListItem disableGutters>
                          <ListItemText
                            primary="Non-Sarcastic"
                            primaryTypographyProps={{
                              variant: 'h5',
                              noWrap: true
                            }}
                            secondary="Non-Sarcastic Count"
                            secondaryTypographyProps={{
                              variant: 'subtitle2',
                              noWrap: true
                            }}
                          ...
                          <Box>
                            ...
                            <Text color="success">
                              {analytics?.sum?.notSarc?.toFixed(0)}
                            </Text>
                          </Box>
                        </ListItem>
                      </List>
                      ...
                      >
                        ...
                        <ListItem disableGutters>
                          ...
                          <Box>
                            ...
                            <Text color="success">
                              {analytics?.sum?.hyperbole?.toFixed(0)}
                            </Text>
                          </Box>
                        </ListItem>
                        <ListItem disableGutters>
