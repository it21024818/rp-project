...
import { useGetpredictionSentimentAnalyticsQuery } from 'src/store/apiquery/predictionsApiSlice';
            ...
            <CardContent>
              <Box sx={{ width: '100%' }}>
                ...
                >
                  ...
                  <Tab label="Positive/Negative" {...a11yProps(1)} />
                  <Tab label="Tweet/News" {...a11yProps(2)} />
                </Tabs>
                    ...
                    >
                      <Chart
                        ...
                        series={
                          analytics
                            ? [
                                analytics?.sum?.positive,
                                analytics?.sum?.negative
                              ]
                            : [0, 0]
                        }
                        type="donut"
                      ...
                      >
                        <ListItem disableGutters>
                          ...
                          <Box>
                            ...
                            <Text color="success">
                              {analytics?.sum?.positive?.toFixed(0)}
                            </Text>
                          </Box>
                        </ListItem>
                        <ListItem disableGutters>
                          ...
                          <Box>
                            ...
                            <Text color="success">
                              {analytics?.sum?.negative?.toFixed(0)}
                            </Text>
                          </Box>
                        </ListItem>
                      </List>
                  ...
                  <Grid container spacing={4}>
                    ...
                    >
                      <Chart
                        ...
                        series={
                          analytics
                            ? [analytics?.sum?.tweet, analytics?.sum?.news]
                            : [0, 0]
                        }
                        type="donut"
                      />
